...
export function AddPropertyPage() {
  ...
  const addPropertyToStore = usePropertyStore((s) => s.addProperty);
  ...
  const payload = useMemo(() => {
    ...
    return {
      ...
      images,
    } satisfies Omit<Property, 'id' | 'agent' | 'createdAt' | 'updatedAt'>;
  }, [form]);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600 mb-4">Only agents and sellers can create listings.</p>
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    if (!payload.location.address || !payload.location.city || !payload.location.state || !payload.location.zipCode) {
    ...
    try {
      ...
      addPropertyToStore(created);
      navigate('/dashboard/properties');
    } catch {
      setError('Could not create property. Make sure you are logged in and the API is running.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-1">Add a property</h1>
          <p className="text-gray-600 mb-6">Create a new listing that buyers can find and save.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  rows={4}
                  placeholder="Highlight the best features, neighborhood, and what makes it special."
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  inputMode="decimal"
                  placeholder={isRent ? '1800' : '450000'}
                />
              </div>
